...
Layout is chosen per branch from the branch's context menu, so a sprawling refactor can
be grouped while a three-file fix stays a list. `butReview.fileLayout` sets the default
